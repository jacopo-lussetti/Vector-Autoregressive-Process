...
results
```
From results we can see that using the largest lambda s.t.  the error is within one standard error of the minimum (lambda.1se)
gives better results in terms of type I error, precision and F1 score.
